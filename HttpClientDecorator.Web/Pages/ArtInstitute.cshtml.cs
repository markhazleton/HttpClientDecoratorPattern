...
public class ArtInstituteModel : PageModel
{
    ...
    public HttpGetCallResults<ArtWorksResponse> artResponse { get; set; } = default!;
    public ArtWorksResponse artWorksResponse { get; set; } = new ArtWorksResponse();
    public ArtList ArtList { get; set; } = new ArtList();
    public ArtInstituteModel(ILogger<ArtInstituteModel> logger, IHttpGetCallService getCallService)
    {
        _logger = logger;
    ...
    {
        artResponse = new HttpGetCallResults<ArtWorksResponse>();
